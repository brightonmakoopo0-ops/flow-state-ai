  ...
  head: () => ({
    meta: [
      ...
      { title: "WorkFlow AI — Intelligent Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "AI email drafting, meeting summarisation and task scheduling in one responsible-AI workspace.",
      },
      { name: "author", content: "WorkFlow AI" },
      { property: "og:title", content: "WorkFlow AI" },
      {
        property: "og:description",
        content: "One workspace for AI-assisted workplace productivity.",
      },
